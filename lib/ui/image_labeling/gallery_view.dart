      ...
      Padding(
        ...
        child: ElevatedButton(
          style: ElevatedButton.styleFrom(
            foregroundColor: Color(0xff20AE67),
            backgroundColor: Color(0xff20AE67),
            disabledForegroundColor: Colors.grey.withOpacity(0.38),
            disabledBackgroundColor:
                Colors.grey.withOpacity(0.12), // Buton aktif değilken rengi
          ),
          onPressed: _getImageAsset,
          child: Text('From Assets', style: TextStyle(color: Colors.white)),
        ),
      ),
      Padding(
        padding: EdgeInsets.symmetric(horizontal: 16),
        child: ElevatedButton(
          child: Text('Galeriden Yükle', style: TextStyle(color: Colors.white)),
